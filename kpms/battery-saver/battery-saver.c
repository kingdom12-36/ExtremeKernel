...
/*
 * battery-saver.kpm  v2.4  -  ExtremeKernel Battery Saver
 ...
 *
 * Changelog:
 *   v2.4 - use pr_warn for key messages so they survive dmesg ring-buffer
 *          wrap and show even if console_loglevel was lowered by disabler.
 */
...
{
    pr_warn("[EK-BATT] battery-saver v2.4 loading...\n");
    ...
    pr_warn("[EK-BATT] LOADED v2.4: swappiness %d->20, writeback %d->3000, cache_pressure %d->50\n",
...
{
    pr_warn("[EK-BATT] unloading — restoring originals...\n");
    ...
    pr_warn("[EK-BATT] UNLOADED cleanly.\n");
    return 0;
}
